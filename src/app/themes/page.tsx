...
export default function ThemesPage() {
  ...
  return (
    <div className="flex justify-between">
      ...
      >
        <div className="absolute  top-12 right-0 bottom-0 left-12 bg-white rounded-ss-xl px-12 py-6">
          ...
          <p className="scroll-m-20  pb-2 text-xl font-semibold text-muted-foreground tracking-tight first:mt-0">
          ...
          <div>
            <p className="p-4 border-dashed border-2 text-muted-foreground ">
